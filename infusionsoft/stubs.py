...
class APIAffiliateService:
    @staticmethod
    def affClawbacks(affiliateId: int,
    ...
    @staticmethod
    def affCommissions(affiliateId: int,
                       filterStartDate: datetime,
                       filterEndDate: datetime) -> List:
    ...
    @staticmethod
    def affPayouts(affiliateId: int,
                   filterStartDate: datetime,
                   filterEndDate: datetime) -> List:
        """Retrieve Payments.
    ...
    @staticmethod
    def affSummary(affiliateId: int,
                   filterStartDate: datetime,
                   filterEndDate: datetime) -> List:
...
class APIEmailService:
    @staticmethod
    def addEmailTemplate(templateName: str,
                         categories: str,
                         fromAddress: str,
                         toAddress: str,
                         ccAddress: str,
    ...
    @staticmethod
    def sendEmail(contactList: List,
                  fromAddress: str,
                  toAddress: str,
                  ccAddresses: str,
                  bccAddresses: str,
    ...
    @staticmethod
    def updateEmailTemplate(templateId: str,
                            templateName: str,
                            categories: str,
                            fromAddress: str,
                            toAddress: str,
...
class ContactService:
    ...
    @staticmethod
    def linkContacts(contactId1: int=None,
                     contactId2: int=None,
                     linkTypeId: int=None) -> bool:
        """Link Contacts.
    ...
    @staticmethod
    def listLinkedContacts(contactId: int=None) -> List:
    ...
    @staticmethod
    def unlinkContacts(contactId1: int=None,
                       contactId2: int=None,
                       linkTypeId: int=None) -> bool:
        """Unlink Contacts.
...
class DataService:
    ...
    @staticmethod
    def addCustomField(customFieldType: str,
                       displayName: str,
                       dataType: str,
                       headerID: int) -> int:
    ...
    @staticmethod
    def updateCustomField(customFieldId: int,
...
class DiscountService:
    ...
    @staticmethod
    def addCategoryDiscount(name: str,
                            description: str,
    ...
    @staticmethod
    def addFreeTrial(name: str,
                     description: str,
                     freeTrialDays: int,
                     hidePrice: int,
                     subscriptionPlanID: int) -> int:
        """Create a Free Trial on a Subscription."""
        pass

    @staticmethod
    def addOrderTotalDiscount(name: str,
                              applyDiscountToCommission: int,
                              percentOrAmt: int,
                              payType: str) -> int:
    ...
    @staticmethod
    def addProductTotalDiscount(name: str,
                                description: str,
                                applyDiscountToCommission: int,
                                productID: int,
                                percentOrAmt: int,
    ...
    @staticmethod
    def addShippingTotalDiscount(name: str,
                                 description: str,
                                 applyDiscountToCommission: int,
                                 percentOrAmt: int,
                                 amt: float) -> int:
...
class InvoiceService:
    @staticmethod
    def addManualPayment(invoiceID: int,
                         amount: float,
                         date: datetime,
                         paymentType: str,
                         description: str,
    ...
    @staticmethod
    def addOrderCommissionOverride(invoiceID: int,
                                   affiliateID: int,
                                   productID: int,
                                   percent: int,
                                   amount: float,
    ...
    @staticmethod
    def addOrderItem(invoiceID: int,
                     productID: int,
                     type: int,
                     price: float,
                     quantity: int,
    ...
    @staticmethod
    def addPaymentPlan(invoiceID: int,
                       autoCharge: bool,
                       creditCardID: int,
    ...
    @staticmethod
    def addRecurringOrder(contactID: int,
                          allowDuplicate: bool,
                          subscriptionID: int,
                          quantity: int,
                          price: float,
    ...
    @staticmethod
    def chargeInvoice(invoiceID: int,
                      notes: str,
                      creditCardID: int,
                      merchantAccountID: int,
    ...
    @staticmethod
    def createBlankOrder(contactID: int,
                         name: str,
                         orderDate: datetime,
                         leadAffiliateID: int,
                         saleAffiliateID: int) -> int:
        """Create an Invoice.
...
class OrderService:
    @staticmethod
    def placeOrder(contactID: int,
                   cardID: int,
                   planID: int,
                   productIDs: List,
                   subscriptionIDs: List,
                   processSpecials: bool,
                   promoCodes: List,
                   leadAffiliateID: int,
...
class SearchService:
    ...
    @staticmethod
    def getSavedSearchResults(savedSearchID: int,
                              userID: int,
                              pageNumber: int,
                              returnFields: List) -> List:
    ...
    @staticmethod
    def getSavedSearchResultsAllFields(savedSearchID: int,
                                       userID: int,
                                       pageNumber: int) -> List:
    ...
    @staticmethod
    def quickSearch(searchType: int,
                    userID: int,
                    searchData: str,
                    page: int,
                    limit: int) -> List:
